...
### 🖥️ **Frontend (Vue.js / TypeScript)**
  ...
  - **Tailwind CSS v4** para diseño *utility-first* moderno.
  ...
  - **Notificaciones (Toasts)** elegantes con `Vue-Sonner`.
...
*(La API estará disponible en `http://localhost:5272`. La primera ejecución aplicará migraciones y creará el usuario admin)*
...
Abre la dirección del frontend (`http://localhost:5173`) en tu navegador para usar la aplicación. Puedes iniciar sesión con las credenciales de administrador que definiste en los secretos o con tu cuenta de Google.
